...
const sortNumbersByLength = (arr) => {
  return arr.sort((a,b)=> {
    ...
    if (a.toString().length >b.toString().length){return 11;}
    else{ return 0;}
  });
  // Solution code here...
};
...
const sortSchedule = (arr) => {
  ...
  return arr.sort( (a, b) => {
    if (a.dayOfWeek < b.dayOfWeek) return 1;
    if (a.dayOfWeek > b.dayOfWeek) return -1;
    else{ if ((parseInt(a.end)- parseInt(a.start)) < (parseInt(b.end)- parseInt(b.start))) return 1;
      if ((parseInt(a.end)- parseInt(a.start)) > (parseInt(b.end)- parseInt(b.start))) return -1;
      else {return 0; }}
  });
};
